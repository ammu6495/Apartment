    ...
    <aside id="left-panel" class="left-panel">
        <nav class="navbar navbar-expand-sm navbar-default">
            ...
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="./"><img src="img/emp.jpg" width="110px;"alt="Logo"></a>
            ...
            <div id="main-menu" class="main-menu collapse navbar-collapse">
                <ul class="nav navbar-nav">
                    <li class="active">
                        <a href="employeearea.php"> <i class="menu-icon fa fa-dashboard"></i>Home</a>
                    ...
                    <li class="active">
                        <a href="Changepassword.php"> <i class="menu-icon fa fa-dashboard"></i>Change Password</a>
                        <a href="renterdetails.php"> <i class="menu-icon fa fa-dashboard"></i>Renters List</a>
                        <a href="empownerslist.php"> <i class="menu-icon fa fa-dashboard"></i>Owners List</a>
                        <a href="empsalarystatement.php"> <i class="menu-icon fa fa-dashboard"></i>Salary Statement</a>
                        <a href="empschedule.php"> <i class="menu-icon fa fa-dashboard"></i>Employee Schedule</a>
                        <a href="viewrequestedservice.php"> <i class="menu-icon fa fa-dashboard"></i>Requested Service</a>
                    </li>
                            ...
                            <div class="content table-responsive table-full-width">
                                <table class="table table-hover table-striped">
                                 ...
                                 //  echo $loginid = $_SESSION['loginid'];
                                    $query=mysqli_query($con,"SELECT * FROM tbl_renterregister"); 
